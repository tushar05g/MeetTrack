...
import { Mail, Lock, User as UserIcon, UserPlus, AlertCircle, Sparkles, RefreshCw } from 'lucide-react';
            ...
            <div className="glass-panel animate-fade-in" style={{ 
                ...
                <div style={{ textAlign: 'center', marginBottom: '2.25rem' }}>
                    ...
                    <p style={{ margin: 0, color: 'var(--text-secondary)', fontSize: '0.92rem' }}>
                        Join MeetTrack and automate your meeting workflows
                    </p>
                </div>
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                    <div>
                        ...
                        <div style={{ position: 'relative' }}>
                            <UserIcon size={17} style={{ position: 'absolute', left: '1rem', top: '50%', transform: 'translateY(-50%)', color: 'var(--text-secondary)' }} />
                            <input 
                                type="text" 
                                value={name} 
